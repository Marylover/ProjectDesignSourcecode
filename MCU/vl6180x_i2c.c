...
uint16_t ligthPollingRead(void)
...
uint8_t VL6180X_WriteBytes(uint8_t I2C_addr, uint16_t index, uint8_t dat)

{

	uint8_t Index_H = (uint8_t)(index >> 8);

	uint8_t Index_L = (uint8_t)(index & 0xff);
...
uint8_t VL6180x_ReadBytes(uint8_t I2C_addr, uint16_t index) {
...
uint16_t VL6180x_Read_Two_Bytes(uint8_t I2C_addr, uint16_t index) {
